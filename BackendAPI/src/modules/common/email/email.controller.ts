...
import { ApiTags, ApiOperation, ApiCreatedResponse, ApiBadRequestResponse, ApiInternalServerErrorResponse, ApiUnauthorizedResponse } from "@nestjs/swagger";
...
export class EmailController {
    ...
    @ApiCreatedResponse({ description: 'Correo electrónico enviado con éxito', schema: { example: { message: 'Email enviado con exito' } } })
    @ApiBadRequestResponse({ description: 'Solicitud incorrecta' })
    @ApiInternalServerErrorResponse({ description: 'Error interno del servidor' })
    @ApiUnauthorizedResponse({ description: 'Credenciales del email invalidas' })
