...
export class PetsController {
    ...
    @ApiCreatedResponse({ description: 'La mascota ha sido creada con exito', type: Pets }) 
    @ApiBody({ type: CreatePetDto })
    async createNewPet(@Body() newPet: CreatePetDto, @Request() req): Promise<Pets> {
    ...
    @ApiOkResponse({ description: 'La mascoata ha sido actualizada con exito' })
    @ApiBody({ type: CreatePetDto }) 
    async updatePet(
